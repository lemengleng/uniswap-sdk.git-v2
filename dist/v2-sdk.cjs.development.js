...
var FACTORY_ADDRESS = '0x8Bf1dB2753451292A043F67F7630cd5EF26ed4FA'
var INIT_CODE_HASH = '0x410cce05b2dd54661a98f4072b5f924fd1f0be8b710a0f81e55d6e27a75b8a62'
...
var Pair = /*#__PURE__*/ (function() {
  ...
  _proto.getOutputAmount = function getOutputAmount(inputAmount) {
    ...
    var outputAmount = new sdkCore.TokenAmount(
  ...
  _proto.getInputAmount = function getInputAmount(outputAmount) {
    ...
    var inputAmount = new sdkCore.TokenAmount(
  ...
  _proto.getLiquidityValue = function getLiquidityValue(token, totalSupply, liquidity, feeOn, kLast) {
    ...
    return new sdkCore.TokenAmount(
      token,
...
var Route = /*#__PURE__*/ (function() {
  function Route(pairs, input, output) {
    ...
    !(
      (input instanceof sdkCore.Token && pairs[0].involvesToken(input)) ||
      (input === sdkCore.ETHER && weth && pairs[0].involvesToken(weth))
    )
      ? invariant(false, 'INPUT')
      : void 0
    !(
      typeof output === 'undefined' ||
      (output instanceof sdkCore.Token && pairs[pairs.length - 1].involvesToken(output)) ||
      (output === sdkCore.ETHER && weth && pairs[pairs.length - 1].involvesToken(weth))
    )
        ...
        for (
          ...
          prices.push(
            this.path[i].equals(pair.token0)
              ? new sdkCore.Price(pair.reserve0.currency, pair.reserve1.currency, pair.reserve0.raw, pair.reserve1.raw)
              : new sdkCore.Price(pair.reserve1.currency, pair.reserve0.currency, pair.reserve1.raw, pair.reserve0.raw)
          )
        }
...
function inputOutputComparator(a, b) {
  ...
  !sdkCore.currencyEquals(a.outputAmount.currency, b.outputAmount.currency)
...
function wrappedAmount(currencyAmount, chainId) {
  ...
  if (currencyAmount.currency === sdkCore.ETHER)
    return new sdkCore.TokenAmount(sdkCore.WETH9[chainId], currencyAmount.raw)
...
var Trade = /*#__PURE__*/ (function() {
  function Trade(route, amount, tradeType) {
    ...
    this.inputAmount =
      tradeType === sdkCore.TradeType.EXACT_INPUT
        ? amount
        : route.input === sdkCore.ETHER
        ? sdkCore.CurrencyAmount.ether(amounts[0].raw)
        : amounts[0]
    this.outputAmount =
      tradeType === sdkCore.TradeType.EXACT_OUTPUT
        ? amount
        : route.output === sdkCore.ETHER
        ? sdkCore.CurrencyAmount.ether(amounts[amounts.length - 1].raw)
  ...
  _proto.minimumAmountOut = function minimumAmountOut(slippageTolerance) {
    ...
    if (this.tradeType === sdkCore.TradeType.EXACT_OUTPUT) {
      ...
      return this.outputAmount instanceof sdkCore.TokenAmount
        ? new sdkCore.TokenAmount(this.outputAmount.token, slippageAdjustedAmountOut)
        : sdkCore.CurrencyAmount.ether(slippageAdjustedAmountOut)
    }
  }
  /**
  ...
  _proto.maximumAmountIn = function maximumAmountIn(slippageTolerance) {
    ...
    if (this.tradeType === sdkCore.TradeType.EXACT_INPUT) {
      ...
      var slippageAdjustedAmountIn = new sdkCore.Fraction(ONE).add(slippageTolerance).multiply(this.inputAmount.raw)
        .quotient
      return this.inputAmount instanceof sdkCore.TokenAmount
        ? new sdkCore.TokenAmount(this.inputAmount.token, slippageAdjustedAmountIn)
        : sdkCore.CurrencyAmount.ether(slippageAdjustedAmountIn)
    }
  }
  /**
  ...
  Trade.bestTradeExactIn = function bestTradeExactIn(
    ...
    var chainId =
      currencyAmountIn instanceof sdkCore.TokenAmount
        ? currencyAmountIn.token.chainId
        : currencyOut instanceof sdkCore.Token
        ? currencyOut.chainId
        : undefined
  ...
  Trade.bestTradeExactOut = function bestTradeExactOut(
    ...
    !(originalAmountOut === currencyAmountOut || currentPairs.length > 0)
      ...
      : void 0
    var chainId =
      currencyAmountOut instanceof sdkCore.TokenAmount
        ? currencyAmountOut.token.chainId
        : currencyIn instanceof sdkCore.Token
        ? currencyIn.chainId
        : undefined
    !(chainId !== undefined) ? invariant(false, 'CHAIN_ID') : void 0
